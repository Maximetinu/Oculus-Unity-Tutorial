...
namespace OculusSampleFramework
{
    public class GrabManager : MonoBehaviour
    {
        ...
        {
            DistanceGrabbable dg;
            dg = otherCollider.GetComponent<DistanceGrabbable>();
            if (dg == null)
                dg = otherCollider.GetComponentInChildren<DistanceGrabbable>();
            if (dg == null)
                dg = otherCollider.GetComponentInParent<DistanceGrabbable>();
