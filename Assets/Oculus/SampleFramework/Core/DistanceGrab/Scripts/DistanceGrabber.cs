    ...
    public class DistanceGrabber : OVRGrabber
    {
        ...
        void SetOffsetPositions()
        {
            ...
            if (m_grabbedObj.snapOffset)
            {
                ...
                if (m_controller == OVRInput.Controller.LTouch) m_grabbedObjectRotOff = Quaternion.Inverse(m_grabbedObjectRotOff);  // Set also the inverse of rotation
            }
        }
        ...
        protected override void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
        {
            ...
            // Set offset positions during playmode for easy positioning
